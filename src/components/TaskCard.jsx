...
const TaskCard = ({ task, fetchAllTasks }) => {
  const handleCompleteTask = async () => {
    try {
      await axios.patch(`https://express-intro-starting-point-five.vercel.app/api/tasks/${task.id}`, {
  ...
  const handleDeleteTask = async () => {
    try {
      await axios.delete(`https://express-intro-starting-point-five.vercel.app/api/tasks/${task.id}`);
      fetchAllTasks();
    } catch (error) {
